...
#define CLK 10 //PINO DIGITAL UTILIZADO PELO CLK
#define DIO 11 //PINO DIGITAL UTILIZADO PELO DIO
...
void loop() {
  ...
  display.showNumberDec( dht.temperature().getEvent(&event),false);
  delay(1500);
  display.showNumberDec(event.relative_humidity, false);
}
